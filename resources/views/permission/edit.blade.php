    ...
    <div class="py-3">
        ...
        <nav class="flex px-5 py-3 text-gray-700 border border-gray-200 rounded-lg bg-gray-50 dark:bg-gray-800 dark:border-gray-700" aria-label="Breadcrumb">
            <ol class="inline-flex items-center space-x-1 md:space-x-3">
                ...
                <li class="inline-flex items-center">
                    <a href="{{ route('permissionsIndex') }}" class="inline-flex items-center text-sm font-medium text-gray-700 hover:text-blue-600 dark:text-gray-400 dark:hover:text-white">
                        {{ __('الأذونات') }}
                    </a>
                    <span class="px-2"><i class="fa-solid fa-chevron-left"></i></span>
                </li>
        ...
        <div class="mb-4 flex flex-col px-8 pb-8 pt-6 bg-white border rounded-lg shadow">
            ...
            <form method="post" action="{{ route('permissionUpdate',['id'=>request()->id]) }}">
                @csrf()
                @method('put')
